$(document).ready(function() {
    ...
    $('#tous-articles').on('click', () => {
        ...
        window.api.send('envoi-chg-grp-gest');
    });
    // retour de la modale pour choisir un groupe
    window.api.receive('retour-chg-grp-gest', (arg) => {
    ...
    window.api.receive('retour-rech-article-gest', (arg) => {
    ...
    $("#rechArtGest").on('change paste keyup', function(event) {
        ...
        if ($('#rechArtGest').val().trim().toUpperCase() == '') {} else {
            window.api.send('envoi-rech-article-gest', $('#rechArtGest').val().trim().toUpperCase());
        }
    });
    ...
    $("#descript-nouvArt-gest").on('change paste keyup', function(event) {
        window.api.send('envoi-description-article-gest', $('#descript-nouvArt-gest').val().trim().toUpperCase());
    });
    ...
    $("#code-nouvArt-gest").on('change paste keyup', function(event) {
        window.api.send('envoi-code-article-gest', $('#code-nouvArt-gest').val().trim().toUpperCase());
    });
